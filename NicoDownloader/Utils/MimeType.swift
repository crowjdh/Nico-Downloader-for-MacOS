...
internal func mimeTypeOf(extension ext: String?) -> String {
...
extension URL {
    public func mimeType() -> String {
        return mimeTypeOf(extension: self.pathExtension)
    }
    
    public func topLevelMimeType() -> String? {
        return topLevelMimeTypeOf(mimeType: mimeType())
    }
}
